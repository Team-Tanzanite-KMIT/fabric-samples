...
if ! docker ps; then systemctl start docker; fi;
...
./network.sh deployCC -ccn filebasic -ccp /home/rohith/Documents/Team-Tanzanite-PS/chaincode -ccl typescript
